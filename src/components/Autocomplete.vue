<template>
  <div class="space-y-6">
    ...
    <div>
      <div v-if="searchResults.length"><PhotoGallery :data="searchResults" :image="{ tooltip: false, variant: 'composition' }" /></div>
      <div v-else-if="!searchResults.length && search.length" class="flex flex-col items-center justify-center h-[30vh]">
